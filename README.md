...
**6.** Да се разработи activity, което изобразява Колекция от потребители (снимка, имена, пол) с помомощта на RecyclerView и CardView. Да се добави FAB бутон, който с подходящ диалог (или второ activity) позволява добавянето на нови потребители към колекцията.
