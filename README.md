...
Да се създаде приложение, което съхранява данни в поне две свързани SQLite таблици (футболисти и отбори, студенти и дисциплини, продукти и категории и т.н.).
